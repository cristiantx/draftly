...
var chunk7HUCJHMI_cjs = require('./chunk-7HUCJHMI.cjs');
...
var InlinePlugin = class extends chunkEQUQHE2E_cjs.DecorationPlugin {
   ...
   */
  getExtensions() {
    return [chunk7HUCJHMI_cjs.createWrapSelectionInputHandler({ "*": "*", _: "_", "~": "~", "^": "^", "=": "==" })];
  }
  /**
...
function createPreviewRenderer(markdown, config) {
  ...
  return new chunkKTTVXTSR_cjs.PreviewRenderer(markdown, plugins, config?.markdown || [], config?.theme || "auto" /* AUTO */, true);
}
...
var MathPlugin = class extends chunkEQUQHE2E_cjs.DecorationPlugin {
   ...
   */
  getExtensions() {
    return [chunk7HUCJHMI_cjs.createWrapSelectionInputHandler({ "$": "$" })];
  }
  /**
...
//# sourceMappingURL=chunk-PNNYG5V6.cjs.map
//# sourceMappingURL=chunk-PNNYG5V6.cjs.map